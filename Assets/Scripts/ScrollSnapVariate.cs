...
public class ScrollSnapVariate : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler {
    ...
    [Tooltip("Dock to be disapearing")]
    public Transform dock;
	[Tooltip("Object to be fade out")]
    public CanvasGroup fade;
	[Tooltip("Object to be fade out [2]")]
    public CanvasGroup fade2;
	[Tooltip("Object to be fade in ")]
    public CanvasGroup fade3;    
    [Tooltip("Object to be fade in ")]
    public CanvasGroup fade4;    


    public InitMotion init;
